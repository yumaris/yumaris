...
import { SURAH_LIST, APPS_SCRIPT_URL } from './constants';
...
const App: React.FC = () => {
  ...
  const handleSubmitSetor = async (participantId: string) => {
    ...
    try {
      ...
      // 2. Send to Google Apps Script (Legacy/Integration)
      const params = new URLSearchParams();
      params.append('action', 'setor');
      params.append('Nomor Peserta', participantId);
      params.append('Surat', selectedSurah.name);
      params.append('Ayat', String(setorAyah));
